...
mixin _$AttendanceEntry {
 ...
 String get dpId; String get dpCode; String get name;@JsonKey(name: 'photoUrl') String? get profilePictureUrl; AttendanceStatus get status; String? get recordId; String? get markedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dpId,dpCode,name,profilePictureUrl,status,recordId,markedAt);

@override
String toString() {
  return 'AttendanceEntry(dpId: $dpId, dpCode: $dpCode, name: $name, profilePictureUrl: $profilePictureUrl, status: $status, recordId: $recordId, markedAt: $markedAt)';
}
...
@useResult
$Res call({
 String dpId, String dpCode, String name,@JsonKey(name: 'photoUrl') String? profilePictureUrl, AttendanceStatus status, String? recordId, String? markedAt
});
...
/// Create a copy of AttendanceEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dpId = null,Object? dpCode = null,Object? name = null,Object? profilePictureUrl = freezed,Object? status = null,Object? recordId = freezed,Object? markedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String dpId,  String dpCode,  String name, @JsonKey(name: 'photoUrl')  String? profilePictureUrl,  AttendanceStatus status,  String? recordId,  String? markedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttendanceEntry() when $default != null:
return $default(_that.dpId,_that.dpCode,_that.name,_that.profilePictureUrl,_that.status,_that.recordId,_that.markedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String dpId,  String dpCode,  String name, @JsonKey(name: 'photoUrl')  String? profilePictureUrl,  AttendanceStatus status,  String? recordId,  String? markedAt)  $default,) {final _that = this;
switch (_that) {
case _AttendanceEntry():
return $default(_that.dpId,_that.dpCode,_that.name,_that.profilePictureUrl,_that.status,_that.recordId,_that.markedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String dpId,  String dpCode,  String name, @JsonKey(name: 'photoUrl')  String? profilePictureUrl,  AttendanceStatus status,  String? recordId,  String? markedAt)?  $default,) {final _that = this;
switch (_that) {
case _AttendanceEntry() when $default != null:
return $default(_that.dpId,_that.dpCode,_that.name,_that.profilePictureUrl,_that.status,_that.recordId,_that.markedAt);case _:
  return null;
...
class _AttendanceEntry extends AttendanceEntry {
  const _AttendanceEntry({required this.dpId, required this.dpCode, required this.name, @JsonKey(name: 'photoUrl') this.profilePictureUrl, this.status = AttendanceStatus.pending, this.recordId, this.markedAt}): super._();
...
/// Create a copy of AttendanceEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dpId = null,Object? dpCode = null,Object? name = null,Object? profilePictureUrl = freezed,Object? status = null,Object? recordId = freezed,Object? markedAt = freezed,}) {
