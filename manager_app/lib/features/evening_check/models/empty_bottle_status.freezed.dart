...
mixin _$EmptyBottleStatus {
 ...
 String get routeId; String get routeName; String? get dpId; String? get dpName; bool get deliveryCompleted; int get oneLBottlesCollected; int get halfLBottlesCollected; int get halfLPacketCollected; int get expected1LBottles; int get expectedHalfLBottles; int get expectedHalfLPacket; int get actualDelivered1L; int get actualDeliveredHalfL; int get actualDeliveredPacket; bool get flagIssue; String get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,routeId,routeName,dpId,dpName,deliveryCompleted,oneLBottlesCollected,halfLBottlesCollected,halfLPacketCollected,expected1LBottles,expectedHalfLBottles,expectedHalfLPacket,actualDelivered1L,actualDeliveredHalfL,actualDeliveredPacket,flagIssue,status);

@override
String toString() {
  return 'EmptyBottleStatus(routeId: $routeId, routeName: $routeName, dpId: $dpId, dpName: $dpName, deliveryCompleted: $deliveryCompleted, oneLBottlesCollected: $oneLBottlesCollected, halfLBottlesCollected: $halfLBottlesCollected, halfLPacketCollected: $halfLPacketCollected, expected1LBottles: $expected1LBottles, expectedHalfLBottles: $expectedHalfLBottles, expectedHalfLPacket: $expectedHalfLPacket, actualDelivered1L: $actualDelivered1L, actualDeliveredHalfL: $actualDeliveredHalfL, actualDeliveredPacket: $actualDeliveredPacket, flagIssue: $flagIssue, status: $status)';
}
...
as int,halfLPacketCollected: null == halfLPacketCollected ? _self.halfLPacketCollected : halfLPacketCollected // ignore: cast_nullable_to_non_nullable
as int,expected1LBottles: null == expected1LBottles ? _self.expected1LBottles : expected1LBottles // ignore: cast_nullable_to_non_nullable
as int,expectedHalfLBottles: null == expectedHalfLBottles ? _self.expectedHalfLBottles : expectedHalfLBottles // ignore: cast_nullable_to_non_nullable
as int,expectedHalfLPacket: null == expectedHalfLPacket ? _self.expectedHalfLPacket : expectedHalfLPacket // ignore: cast_nullable_to_non_nullable
as int,actualDelivered1L: null == actualDelivered1L ? _self.actualDelivered1L : actualDelivered1L // ignore: cast_nullable_to_non_nullable
as int,actualDeliveredHalfL: null == actualDeliveredHalfL ? _self.actualDeliveredHalfL : actualDeliveredHalfL // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String routeId,  String routeName,  String? dpId,  String? dpName,  bool deliveryCompleted,  int oneLBottlesCollected,  int halfLBottlesCollected,  int halfLPacketCollected,  int expected1LBottles,  int expectedHalfLBottles,  int expectedHalfLPacket,  int actualDelivered1L,  int actualDeliveredHalfL,  int actualDeliveredPacket,  bool flagIssue,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EmptyBottleStatus() when $default != null:
return $default(_that.routeId,_that.routeName,_that.dpId,_that.dpName,_that.deliveryCompleted,_that.oneLBottlesCollected,_that.halfLBottlesCollected,_that.halfLPacketCollected,_that.expected1LBottles,_that.expectedHalfLBottles,_that.expectedHalfLPacket,_that.actualDelivered1L,_that.actualDeliveredHalfL,_that.actualDeliveredPacket,_that.flagIssue,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String routeId,  String routeName,  String? dpId,  String? dpName,  bool deliveryCompleted,  int oneLBottlesCollected,  int halfLBottlesCollected,  int halfLPacketCollected,  int expected1LBottles,  int expectedHalfLBottles,  int expectedHalfLPacket,  int actualDelivered1L,  int actualDeliveredHalfL,  int actualDeliveredPacket,  bool flagIssue,  String status)  $default,) {final _that = this;
switch (_that) {
case _EmptyBottleStatus():
return $default(_that.routeId,_that.routeName,_that.dpId,_that.dpName,_that.deliveryCompleted,_that.oneLBottlesCollected,_that.halfLBottlesCollected,_that.halfLPacketCollected,_that.expected1LBottles,_that.expectedHalfLBottles,_that.expectedHalfLPacket,_that.actualDelivered1L,_that.actualDeliveredHalfL,_that.actualDeliveredPacket,_that.flagIssue,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey() final  int oneLBottlesCollected;
@override@JsonKey() final  int halfLBottlesCollected;
@override@JsonKey() final  int halfLPacketCollected;
@override@JsonKey() final  int expected1LBottles;
@override@JsonKey() final  int expectedHalfLBottles;
@override@JsonKey() final  int expectedHalfLPacket;
@override@JsonKey() final  int actualDelivered1L;
@override@JsonKey() final  int actualDeliveredHalfL;
