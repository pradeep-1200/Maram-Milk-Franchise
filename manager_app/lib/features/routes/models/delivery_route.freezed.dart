...
@JsonKey(name: 'routeId') String get id;@JsonKey(name: 'routeName') String get name;@JsonKey(name: 'zone') String get area; int get customerCount;@JsonKey(name: 'defaultLitres') double get milkQuantity; String? get assignedDpId; String? get assignedDpName; String? get assignedDpPhotoUrl; String? get allocationId; int get qty1LBottle; int get qtyHalfLBottle; int get fixedPetrolAllowance; bool get isPetrolAllowanceComplete; int? get petrolAllowanceGiven; bool? get deliveryCompleted; int? get emptyBottles1L; int? get emptyBottlesHalfL; bool get hasBottleReturnFlag; String? get bottleReturnNote;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,area,customerCount,milkQuantity,assignedDpId,assignedDpName,assignedDpPhotoUrl,allocationId,qty1LBottle,qtyHalfLBottle,fixedPetrolAllowance,isPetrolAllowanceComplete,petrolAllowanceGiven,deliveryCompleted,emptyBottles1L,emptyBottlesHalfL,hasBottleReturnFlag,bottleReturnNote]);

@override
String toString() {
  return 'DeliveryRoute(id: $id, name: $name, area: $area, customerCount: $customerCount, milkQuantity: $milkQuantity, assignedDpId: $assignedDpId, assignedDpName: $assignedDpName, assignedDpPhotoUrl: $assignedDpPhotoUrl, allocationId: $allocationId, qty1LBottle: $qty1LBottle, qtyHalfLBottle: $qtyHalfLBottle, fixedPetrolAllowance: $fixedPetrolAllowance, isPetrolAllowanceComplete: $isPetrolAllowanceComplete, petrolAllowanceGiven: $petrolAllowanceGiven, deliveryCompleted: $deliveryCompleted, emptyBottles1L: $emptyBottles1L, emptyBottlesHalfL: $emptyBottlesHalfL, hasBottleReturnFlag: $hasBottleReturnFlag, bottleReturnNote: $bottleReturnNote)';
}
...
@useResult
$Res call({
@JsonKey(name: 'routeId') String id,@JsonKey(name: 'routeName') String name,@JsonKey(name: 'zone') String area, int customerCount,@JsonKey(name: 'defaultLitres') double milkQuantity, String? assignedDpId, String? assignedDpName, String? assignedDpPhotoUrl, String? allocationId, int qty1LBottle, int qtyHalfLBottle, int fixedPetrolAllowance, bool isPetrolAllowanceComplete, int? petrolAllowanceGiven, bool? deliveryCompleted, int? emptyBottles1L, int? emptyBottlesHalfL, bool hasBottleReturnFlag, String? bottleReturnNote
});
...
/// Create a copy of DeliveryRoute
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? area = null,Object? customerCount = null,Object? milkQuantity = null,Object? assignedDpId = freezed,Object? assignedDpName = freezed,Object? assignedDpPhotoUrl = freezed,Object? allocationId = freezed,Object? qty1LBottle = null,Object? qtyHalfLBottle = null,Object? fixedPetrolAllowance = null,Object? isPetrolAllowanceComplete = null,Object? petrolAllowanceGiven = freezed,Object? deliveryCompleted = freezed,Object? emptyBottles1L = freezed,Object? emptyBottlesHalfL = freezed,Object? hasBottleReturnFlag = null,Object? bottleReturnNote = freezed,}) {
...
as String?,allocationId: freezed == allocationId ? _self.allocationId : allocationId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'routeId')  String id, @JsonKey(name: 'routeName')  String name, @JsonKey(name: 'zone')  String area,  int customerCount, @JsonKey(name: 'defaultLitres')  double milkQuantity,  String? assignedDpId,  String? assignedDpName,  String? assignedDpPhotoUrl,  String? allocationId,  int qty1LBottle,  int qtyHalfLBottle,  int fixedPetrolAllowance,  bool isPetrolAllowanceComplete,  int? petrolAllowanceGiven,  bool? deliveryCompleted,  int? emptyBottles1L,  int? emptyBottlesHalfL,  bool hasBottleReturnFlag,  String? bottleReturnNote)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeliveryRoute() when $default != null:
return $default(_that.id,_that.name,_that.area,_that.customerCount,_that.milkQuantity,_that.assignedDpId,_that.assignedDpName,_that.assignedDpPhotoUrl,_that.allocationId,_that.qty1LBottle,_that.qtyHalfLBottle,_that.fixedPetrolAllowance,_that.isPetrolAllowanceComplete,_that.petrolAllowanceGiven,_that.deliveryCompleted,_that.emptyBottles1L,_that.emptyBottlesHalfL,_that.hasBottleReturnFlag,_that.bottleReturnNote);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'routeId')  String id, @JsonKey(name: 'routeName')  String name, @JsonKey(name: 'zone')  String area,  int customerCount, @JsonKey(name: 'defaultLitres')  double milkQuantity,  String? assignedDpId,  String? assignedDpName,  String? assignedDpPhotoUrl,  String? allocationId,  int qty1LBottle,  int qtyHalfLBottle,  int fixedPetrolAllowance,  bool isPetrolAllowanceComplete,  int? petrolAllowanceGiven,  bool? deliveryCompleted,  int? emptyBottles1L,  int? emptyBottlesHalfL,  bool hasBottleReturnFlag,  String? bottleReturnNote)  $default,) {final _that = this;
switch (_that) {
case _DeliveryRoute():
return $default(_that.id,_that.name,_that.area,_that.customerCount,_that.milkQuantity,_that.assignedDpId,_that.assignedDpName,_that.assignedDpPhotoUrl,_that.allocationId,_that.qty1LBottle,_that.qtyHalfLBottle,_that.fixedPetrolAllowance,_that.isPetrolAllowanceComplete,_that.petrolAllowanceGiven,_that.deliveryCompleted,_that.emptyBottles1L,_that.emptyBottlesHalfL,_that.hasBottleReturnFlag,_that.bottleReturnNote);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'routeId')  String id, @JsonKey(name: 'routeName')  String name, @JsonKey(name: 'zone')  String area,  int customerCount, @JsonKey(name: 'defaultLitres')  double milkQuantity,  String? assignedDpId,  String? assignedDpName,  String? assignedDpPhotoUrl,  String? allocationId,  int qty1LBottle,  int qtyHalfLBottle,  int fixedPetrolAllowance,  bool isPetrolAllowanceComplete,  int? petrolAllowanceGiven,  bool? deliveryCompleted,  int? emptyBottles1L,  int? emptyBottlesHalfL,  bool hasBottleReturnFlag,  String? bottleReturnNote)?  $default,) {final _that = this;
switch (_that) {
case _DeliveryRoute() when $default != null:
return $default(_that.id,_that.name,_that.area,_that.customerCount,_that.milkQuantity,_that.assignedDpId,_that.assignedDpName,_that.assignedDpPhotoUrl,_that.allocationId,_that.qty1LBottle,_that.qtyHalfLBottle,_that.fixedPetrolAllowance,_that.isPetrolAllowanceComplete,_that.petrolAllowanceGiven,_that.deliveryCompleted,_that.emptyBottles1L,_that.emptyBottlesHalfL,_that.hasBottleReturnFlag,_that.bottleReturnNote);case _:
  return null;
...
class _DeliveryRoute implements DeliveryRoute {
  const _DeliveryRoute({@JsonKey(name: 'routeId') required this.id, @JsonKey(name: 'routeName') required this.name, @JsonKey(name: 'zone') required this.area, required this.customerCount, @JsonKey(name: 'defaultLitres') required this.milkQuantity, this.assignedDpId, this.assignedDpName, this.assignedDpPhotoUrl, this.allocationId, this.qty1LBottle = 0, this.qtyHalfLBottle = 0, this.fixedPetrolAllowance = 80, this.isPetrolAllowanceComplete = false, this.petrolAllowanceGiven, this.deliveryCompleted, this.emptyBottles1L, this.emptyBottlesHalfL, this.hasBottleReturnFlag = false, this.bottleReturnNote});
...
/// Create a copy of DeliveryRoute
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? area = null,Object? customerCount = null,Object? milkQuantity = null,Object? assignedDpId = freezed,Object? assignedDpName = freezed,Object? assignedDpPhotoUrl = freezed,Object? allocationId = freezed,Object? qty1LBottle = null,Object? qtyHalfLBottle = null,Object? fixedPetrolAllowance = null,Object? isPetrolAllowanceComplete = null,Object? petrolAllowanceGiven = freezed,Object? deliveryCompleted = freezed,Object? emptyBottles1L = freezed,Object? emptyBottlesHalfL = freezed,Object? hasBottleReturnFlag = null,Object? bottleReturnNote = freezed,}) {
